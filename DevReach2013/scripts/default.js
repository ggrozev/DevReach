...
/*     if (localStorage.myagenda)
{
    ...
    */
    ...
    var agendaData = new kendo.data.DataSource({
      data: [
        { title: "What is Web API? How to use it in the real world? Some text more.", speaker: "Derik Whittaker",  duration: "75 minutes", date: "1 October 2013 4:00 PM" },
        { title: "What is Web API? How to use it in the real world?", speaker: "Derik Whittaker",  duration: "75 minutes", date: "1 October 2013 4:00 PM" },
        { title: "What is Web API? How to use it in the real world?", speaker: "Derik Whittaker",  duration: "75 minutes", date: "1 October 2013 4:00 PM" },
        { title: "What is Web API? How to use it in the real world?", speaker: "Derik Whittaker",  duration: "75 minutes", date: "1 October 2013 4:00 PM" },
        { title: "What is Web API? How to use it in the real world?", speaker: "Derik Whittaker",  duration: "75 minutes", date: "1 October 2013 4:00 PM" },
        { title: "What is Web API? How to use it in the real world?", speaker: "Derik Whittaker",  duration: "75 minutes", date: "1 October 2013 4:00 PM" },
...
function OnHomeViewLoad()
{
    ...
    {
        //$("#modalview-usersettings").data("kendoMobileModalView").open(); //Open Login form
    }    
}
